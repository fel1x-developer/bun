...
const CompilerRT = struct {
    ...
    pub fn inject(state: *TCC.TCCState) void {
        ...
        _ = TCC.tcc_add_symbol(state, "NapiHandleScope__open", &JSC.napi.NapiHandleScope.NapiHandleScope__open);
        _ = TCC.tcc_add_symbol(state, "NapiHandleScope__close", &JSC.napi.NapiHandleScope.NapiHandleScope__close);
